...
export const addNewAdmin = catchAsyncErrors(async (req, res, next) => {
  try {
    ...
    next(new ErrorHandler("Failed to register admin", 500));
  }
});
...
export const getAllDoctors = catchAsyncErrors(async (req, res, next) => {
  try {
    ...
    next(new ErrorHandler("Failed to fetch doctors", 500));
  }
});
...
export const logoutAdmin = catchAsyncErrors(async (req, res, next) => {
  try {
    ...
    next(new ErrorHandler("Failed to logout admin", 500));
  }
});
...
export const logoutPatient = catchAsyncErrors(async (req, res, next) => {
  try {
    ...
    next(new ErrorHandler("Failed to logout patient", 500));
  }
});
...
export const addNewDoctor = catchAsyncErrors(async (req, res, next) => {
  try {
    ...
    next(new ErrorHandler("Failed to register doctor", 500));
  }
});
